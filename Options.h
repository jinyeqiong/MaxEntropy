...
public:
  ...
  void setOptions(const vector<string> &vecOption)
  {
    ...
    for (; i < vecOption.size(); ++i) {
      ...
      if (pr.first == "hiddenSize1") hiddenSize1 = atoi(pr.second.c_str());
      if (pr.first == "hiddenSize2") hiddenSize2 = atoi(pr.second.c_str());
      if (pr.first == "hiddenSize3") hiddenSize3 = atoi(pr.second.c_str());
      if (pr.first == "hiddenSize4") hiddenSize4 = atoi(pr.second.c_str());
  ...
  void showOptions() {
    ...
    std::cout << "hiddenSize1 = " << hiddenSize1 << std::endl;
    std::cout << "hiddenSize2 = " << hiddenSize2 << std::endl;
    std::cout << "hiddenSize3 = " << hiddenSize3 << std::endl;
    std::cout << "hiddenSize4 = " << hiddenSize4 << std::endl;
